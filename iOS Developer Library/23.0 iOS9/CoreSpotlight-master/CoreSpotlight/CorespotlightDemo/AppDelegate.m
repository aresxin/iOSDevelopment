...
- (void)application:(UIApplication *)application didUpdateUserActivity:(NSUserActivity *)userActivity {
    ...
    UINavigationController *naviattionController = (UINavigationController *)self.window.rootViewController;
    [naviattionController popToRootViewControllerAnimated:YES];
    
    CoreSpotlightTableViewController *coreViewController = naviattionController.viewControllers.firstObject;

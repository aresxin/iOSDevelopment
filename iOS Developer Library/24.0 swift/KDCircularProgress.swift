...
public class KDCircularProgress: UIView {
    ...
    override public init(frame: CGRect) {
        ...
        progressLayer.reducedAngleChangedBlock = { (p) -> Void in
            print("B");
        }
    }
    ...
    //动画layer
     class KDCircularProgressViewLayer: CALayer {
        ...
        var reducedAngleChangedBlock: ((Int) -> Void)?
        ...
        override func drawInContext(ctx: CGContext) {
            ...
            let reducedAngle = UtilityFunctions.Mod(angle, range: 360, minMax: (0, 360))//拿这个算比例
            
//            if (reducedAngleChangedBlock != nil) {
//                reducedAngleChangedBlock!(reducedAngle)
//            }

/** 
 * @file  XdwDataObjectBaseSharedMemory.h
 * @brief XdwDataObject::Base::SharedMemoryクラスの定義
 *
 * @author DPC DS&S STD T31G Tomohiro Yamada <Tomohiro.Yamada@fujiexreox.co.jp>
 * @date 2002-3-27
 * @version 1.0
 * $Id: XdwDataObjectBaseSharedMemory.h,v 1.6 2009/12/22 08:11:38 chikyu Exp $
 *
 * Copyright (C) 2002 Fuji Xerox Co., Ltd.
 */

#ifndef _XDW_DATA_OBJECT_BASE_SHARED_MEMORY_H_
#define _XDW_DATA_OBJECT_BASE_SHREAD_MEMORY_H_

/* パッケージを記述するためのIncludeファイル */
#include "DataObject/Base/Include/XdwDataObjectBase.h"

/* 親クラスを定義したIncludeファイル */
#include "DataObject/Base/Header/XdwDataObjectBaseBuffer.h"
 ...
 */
class XdwDataObject::Base::SharedMemory : public XdwDataObject::Base::Buffer
{
public:
     ...
     *                  Byte単位
     */
    SharedMemory(const unsigned char* data, long size);

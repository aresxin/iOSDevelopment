 ...
 * 
 * File: IMG_RopSequence1StepNoDraw.h - 1ステップROP描画シーケンスクラスの定義
 * Yozo Kashima 20.Jul.2001
 *
 */

#ifndef INC_IMG_RopSequence1StepNoDraw_h
#define INC_IMG_RopSequence1StepNoDraw_h
...
/*
 * IMG_RopSequence1StepNoDrawクラスの定義
 */

typedef struct img_ropsequence1stepnodraw {
	IMG_RopSequence		super;		/* SuperClass */
	/*
	 * 関連
	 */
} IMG_RopSequence1StepNoDraw;

/*
 * ファクトリー関数
 */
extern int IMG_RopSequence1StepNoDraw_CreateObjects(
...
extern int IMG_RopSequence1StepNoDraw_Reconstruct(
	IMG_RopSequencePtr		self);

extern IMG_BOOL IMG_RopSequence1StepNoDraw_IsValid(
	IMG_RopSequencePtr			self);

extern IMG_BOOL IMG_RopSequence1StepNoDraw_IsSupported(
	IMG_RopMode					ropMode,	/* ROPシーケンスの最初のステップのROPモード(+) */
	IMG_UINT32					ropCode);	/* ROPシーケンスの最初のステップのROPコード(+) */

/* INC_IMG_RopSequence1StepNoDraw_h */
#endif
...
/* end of IMG_RopSequence1StepNoDraw.h */

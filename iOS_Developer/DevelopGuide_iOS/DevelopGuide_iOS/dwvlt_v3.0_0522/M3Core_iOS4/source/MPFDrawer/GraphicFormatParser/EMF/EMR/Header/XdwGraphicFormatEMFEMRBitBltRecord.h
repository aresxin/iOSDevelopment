/**
 * @file  XdwGraphicFormatEMFEMRBitBltRecord.h
 * @brief XdwGraphicFormat::EMF::EMR::BitBltRecordクラスの定義
 *
 * @author DPC DS&S STD T31G Tomohiro Yamada <Tomohiro.Yamada@fujiexreox.co.jp>
 * @date 2002-3-28
 * @version 1.0
 * $Id: XdwGraphicFormatEMFEMRBitBltRecord.h,v 1.4 2009/12/22 08:10:57 chikyu Exp $
 *
 * Copyright (C) 2002 Fuji Xerox Co., Ltd.
 */

#ifndef _XDW_GRAPHICFORMAT_EMF_EMR_BIT_BLT_RECORD_H_
#define _XDW_GRAPHICFORMAT_EMF_EMR_BIT_BLT_RECORD_H_
...
/**
 * @brief EMR_BITBLTを規定するクラス
 *
 */
class XdwGraphicFormat::EMF::EMR::BitBltRecord : public XdwGraphicFormat::EMF::EMR::RasterRecord
{
public:
     ...
     */
    BitBltRecord(XdwDataObject::Base::Generator* generator);
    
    /**
     * @brief デストラクタ
     */
    virtual ~BitBltRecord();

/**
 * @file  XdwGraphicFormatEMFEMRInvertRgnRecord.h
 * @brief XdwGraphicFormat::EMF::EMR::InvertRgnRecordクラスの定義
 *
...
#ifndef _XDW_GRAPHICFORMAT_EMF_EMR_INVERT_RGN_RECORD_H_
#define _XDW_GRAPHICFORMAT_EMF_EMR_INVERT_RGN_RECORD_H_
 ...
 *
 */
class XdwGraphicFormat::EMF::EMR::InvertRgnRecord : public XdwGraphicFormat::EMF::EMR::RectRecord
{
public:

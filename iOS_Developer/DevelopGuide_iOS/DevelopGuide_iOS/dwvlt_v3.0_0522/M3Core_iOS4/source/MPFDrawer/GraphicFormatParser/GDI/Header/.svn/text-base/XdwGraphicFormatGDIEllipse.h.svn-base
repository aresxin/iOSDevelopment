/**
 * @file  XdwGraphicFormatGDIEllipse.h
 * @brief XdwGraphicFormat::GDI::Ellipseクラスの定義
 *
 * @author DPC DS&S STD T31G Tomohiro Yamada <Tomohiro.Yamada@fujiexreox.co.jp>
 * @date 2002-3-28
 * @version 1.0
 * $Id: XdwGraphicFormatGDIEllipse.h,v 1.4 2009/12/22 08:10:55 chikyu Exp $
 *
 * Copyright (C) 2002 Fuji Xerox Co., Ltd.
 */

#ifndef _XDW_GRAPHIC_FORMAT_GDI_ELLIPSE_H_
#define _XDW_GRAPHIC_FORMAT_GDI_ELLIPSE_H_
 ...
 */
class XdwGraphicFormat::GDI::Ellipse : public XdwEllipse
{
public:

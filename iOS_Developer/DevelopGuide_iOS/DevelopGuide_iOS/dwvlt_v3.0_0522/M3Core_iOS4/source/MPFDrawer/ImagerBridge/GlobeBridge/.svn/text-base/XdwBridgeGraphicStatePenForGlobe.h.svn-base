...
class XdwBridgeGraphicStatePenForGlobe : public XdwBridgeGraphicStatePen {
private:
    imgImager		*imagerF;		//!< 出力先
public:
    XdwBridgeGraphicStatePenForGlobe( imgImager * );	//!< コンストラクタ
    ~XdwBridgeGraphicStatePenForGlobe();		//!< デストラクタ
};

...
class XdwBridgeGraphicStateBrushForGlobe : public XdwBridgeGraphicStateBrush {
private:
    imgImager		*imagerF;	//!< 出力先
public:
    XdwBridgeGraphicStateBrushForGlobe( imgImager * );	//!< コンストラクタ
    ~XdwBridgeGraphicStateBrushForGlobe();		//!< デストラクタ

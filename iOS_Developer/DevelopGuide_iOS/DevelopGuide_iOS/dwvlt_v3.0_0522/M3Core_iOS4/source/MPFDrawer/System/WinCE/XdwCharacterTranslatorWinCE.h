/**
 * @file  XdwCharacterTranslatorWinCE.h
 * @brief XdwCharacterTranslatorWinCEクラスの定義
 *
 * @author DPC DS&S STD T31G Tomohiro Yamada <Tomohiro.Yamada@fujiexreox.co.jp>
 * @date 2002-3-27
 * @version 1.0
 * $Id: XdwCharacterTranslatorWinCE.h,v 1.4 2009/12/22 08:11:31 chikyu Exp $
 *
 * Copyright (C) 2002 Fuji Xerox Co., Ltd.
 */

#ifndef _XDW_CHARACTER_TRANSLATOR_WIN_CE_H_
#define _XDW_CHARACTER_TRANSLATOR_WIN_CE_H_
 ...
 */
class XdwCharacterTranslatorWinCE : public XdwCharacterTranslator
{
public:
     ...
     * @brief コンストラクタ
     */
    XdwCharacterTranslatorWinCE();
    
    /**
     * @brief デストラクタ
     */
    virtual ~XdwCharacterTranslatorWinCE();

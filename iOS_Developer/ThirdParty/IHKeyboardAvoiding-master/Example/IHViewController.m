...
- (void)viewDidLoad
{
    ...
    //[IHKeyboardAvoiding setAvoidingView:self.avoidingView withTarget:self.textField1];
    [IHKeyboardAvoiding setAvoidingView:self.avoidingView withTarget:self.textField2];
    //[IHKeyboardAvoiding addTarget:self.textField2];
